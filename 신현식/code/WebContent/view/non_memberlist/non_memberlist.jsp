...
<html>
<head>
<link rel="stylesheet" type="text/css" href="VIEW/non_memberlist/css/non_memberlist.css">
<meta charset="UTF-8">
...
<body>
	<!-- ---------------------------------header---------------------------------------- -->
	<div class="header">
		<jsp:include page="/VIEW/non_memberlist/non_memberlistHeader.jsp"></jsp:include>
	</div>
	<!-- ---------------------------------main------------------------------------------ -->
<form action="/VIEW/non_memberlist/non_memberlist" method="get">
		<div class="row">
