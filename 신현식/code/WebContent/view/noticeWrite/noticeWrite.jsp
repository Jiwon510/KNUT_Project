...
<body> 
	<article>
		<div class="container" role="main">
			<h2>공지사항 글쓰기</h2>
			<form name="form" id="form" role="form" method="get" action="/VIEW/noticeWrite/noticeWrite">
				<div class="mb-3">
			...
			<div >
				...
				<button type="button" class="btn float-right btn btn-sm btn-primary" onclick="location.href='/VIEW/notice/notice'" id="btnList">목록</button>
			</div>
			</form>
		</div>
	</article>
