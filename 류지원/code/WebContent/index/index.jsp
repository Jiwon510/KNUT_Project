...
<body>
    ...
    <ul class="tabnav">
      ...
      <li><a href="/comment/comment.jsp">동아리소개</a></li>
      <li><a href="/video/video.jsp">대회영상</a></li>
      <li><a href="/board/board">자유게시판</a></li>
      <c:if test="${authority eq '2'}">
      	<li><a href="/memberlist/memberlist">회원목록</a></li>
      	<li><a href="/non_memberlist/non_memberlist">승인목록</a></li>
      </c:if>
    </ul>
